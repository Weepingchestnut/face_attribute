...
# parser.add_argument('--experiment', default='fairface', type=str, required=False, help='(default=%(default)s)')
parser.add_argument('--experiment', default='face_mask', type=str, required=False, help='(default=%(default)s)')
...
parser.add_argument('--decay_epoch', default=(2, 40), type=eval, required=False, help='(default=%(default)d)')
...
def main():
    ...
    if args.evaluate:
        ...
        # fairface
        # print("infer: 10954 / {} = {}".format(during, 10954 / during))
        # celeba
        print("infer: 111388 / {} = {}".format(during, 111388 / during))
        return
...
def save_checkpoint(state, epoch, prefix, filename='.pth.tar'):
    ...
    directory = "work_dir/" + args.experiment + "_checkpoint" + '/'
